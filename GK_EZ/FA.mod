...
parameters betta sig varphi zetta theta alfa G_over_Y eta_i epsilon gam 
gam_P kappa_pi kappa_y rho_i rho_ksi sigma_ksi rho_a sigma_a rho_g sigma_g 
sigma_Ne sigma_i rho_shock_psi sigma_psi kappa tau omega lambda chi b 
delta_c G_ss I_ss nuEZ psiEZ gammaEZ thetaEZ cte;

var Y Ym K L I C G Q Lambda Rk R N Ne Nn nu eta phi z x Pm U X D F Z i 
...
check;
steady;
stoch_simul(PRUNING, order=2, periods=2000, irf=40, nograph);
